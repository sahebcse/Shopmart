...
const AddProduct = () => {
  ...
  const handleAddNewProduct = (e) => {
    ...
    dispatch(
      addNewProduct({ id: user.result._id, productData: newProductData })
    );
  };
      ...
      <div class="col-span-full max-w-6xl">
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          <div className="flex flex-wrap m-2">
            <div className="w-full px-3">
              <label
                ...
                for="grid-question-name"
              >
                Product Name
              </label>
              <input
                className="appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                id="grid-question-name"
                type="text"
          ...
          <div className="flex flex-wrap m-2 mb-6 ">
            <button
              className="py-3 px-4 w-full uppercase font-bold mb-3 m-2 bg-indigo-400 hover:bg-indigo-700 rounded text-black"
