      ...
      <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
        ...
        >
          <ul className="flex flex-col lg:flex-row list-none lg:ml-auto mr-8 text-lg">
            ...
            <button className="px-2 py-1 mr-2 bg-blue-300 text-indigo-800 hover:bg-blue-500 hover:text-white rounded" onClick={()=>window.open(' ')}>Orders</button>
              {
                user?(<button className="px-2 py-1 mr-2 bg-green-300 text-indigo-800 hover:bg-green-500 hover:text-white rounded" onClick={()=>navigate('/user/dashboard')}>Dashboard</button>):<span></span>
              }
              {user && <button className="px-2 py-1 mr-2 bg-yellow-300 text-indigo-800 hover:bg-yellow-500 hover:text-white rounded" onClick={hanldeOpenAllStreams}>Stores</button>}
