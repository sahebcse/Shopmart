    ...
    return (
        <div className="grid md:grid-cols-7">
            ...
            <div className="col-span-5 grid  gap-3">
                ...
                <div onClick={()=>handleClick(result._id)} className="shadow-xl cursor-pointer m-2 p-2 grid grid-cols-3">
                    <div className="">
                        <img src={result.image} />
                    </div>
                    <div className="col-span-2 ml-3 mt-3 lg:mt-14">
                        <p className="font-semibold text-lg">{result.name}</p>
                        <h2 className="text-lg text-gray-400 cursor-pointer">{result.brand}</h2>
                        <p>₹{result.price}</p>
