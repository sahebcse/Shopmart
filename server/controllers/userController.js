...
const stripe = require("stripe")(
  "sk_test_51J8GAsSH4Sh8XwNi5Xis1Tr8xfxwmGyCAQLXeYjduWsCwIFxu11ai2ysISs4JmcO8NtZhwOZNpkzLSm0sfb56dnP00R8VRxPBm"
);
...
const createUser = async (req, res) => {
  try {
    ...
    res
      .status(403)
      .json({ message: "unable to create user account at the moment" });
  }
};

const userLogin = async (req, res) => {
  try {
    const merchant = await User.find({ email: req.body.email }).populate(
      "cart"
    );
